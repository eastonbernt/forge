...
public class InfernalForgeMenu extends AbstractContainerMenu {
    public final InfernalForgeBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public InfernalForgeMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(10));
    }

    public InfernalForgeMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.INFERNAL_MENU.get(), pContainerId);
        checkContainerSize(inv, 10);
        blockEntity = ((InfernalForgeBlockEntity) entity);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level,blockEntity.getBlockPos()),
                player, ModBlocks.INFERNAL_FORGE.get());
    }
