...
public class ModItems {
    ...
    public static final RegistryObject<Item> RA_SPEAR = ITEMS.register("ra_spear",() -> new RaSpear(new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> PHOENIXCHICKEN_SPAWN_EGG = ITEMS.register("phoenixchicken_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.PHOENIXCHICKEN, 0xFFA500, 0xFF0000,
                    new Item.Properties()));
